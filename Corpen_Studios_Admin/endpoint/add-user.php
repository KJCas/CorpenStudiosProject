...
if (isset($_POST['register'])) {
    try {
        ...
        if (empty($nameExist)) {
            ...
            $insertStmt = $conn->prepare("INSERT INTO `tbl_user` (`tbl_user_id`, `first_name`, `last_name`, `contact_number`, `email`, `username`, `password`, `verification_code`)
                                          VALUES (NULL, :first_name, :last_name, :contact_number, :email, :username, :password, :verification_code)");
            ...
            define('EMAIL_ADDRESS', 'lorem.ipsum.sample.email@gmail.com');
            //Server settings
            $mail->isSMTP();
            ...
            //Recipients
            $mail->setFrom(EMAIL_ADDRESS, 'Lorem Ipsum');
            $mail->addAddress($email);
            $mail->addReplyTo(EMAIL_ADDRESS, 'Lorem Ipsum');
            ...
            <script>
                ...
                window.location.href = 'http://localhost/corpen_studios_admin/verification.php';
            </script>
            ";
            ...
            <script>
                ...
                window.location.href = 'http://localhost/corpen_studios_admin/index.php';
            </script>
            ";
        }

...
<head>
  ...
  <link rel="icon" href="vendor/img/CS Logo.png">

  <title>Corpen Studios Booking System - Client Login</title>
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"><img src="CS Logo.png"></img>Corpen Studios Client Login Panel</div>
      <div class="card-body">
        <!--INJECT SWEET ALERT-->
        <!--Trigger Sweet Alert-->
          <?php if(isset($error)) {?>
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="usr-register.php">Register with Corpen Studios</a>
          <a class="d-block small" href="usr-forgot-password.php">Forgot your Password?</a>
          <a class="d-block small" href="../home.php">Back to Home Page</a>
        </div>
      </div>
    </div>
  </div>

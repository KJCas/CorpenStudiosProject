...
<head>
  ...
  <title>Corpen Studios Booking System Client- Register</title>
...
<?php if(isset($succ)) {?>
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header"><img src="CS Logo.png">Corpen Studios - Create An Account With Us</div>
      <div class="card-body">
        <!--Start Form-->
        <form method = "post">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="index.php">Already have an account? Login here</a>

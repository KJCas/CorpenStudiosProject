...
<!--End Navigation-->
  ...
  <div class="container">
    ...
    <h1 class="my-4">Welcome to Corpen Studios Booking System</h1>
    ...
    <div class="row">
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <p class="card-text">We create accountability in the Photograpy sector, enhance mobility and ease of accessing various transport modes</p>
          </div>
    ...
    <hr>
    <!-- Portfolio Section -->
    <h2 class="center">Most Booked Packages</h2>
    <!--Portfolio Section -->
    <hr>
    <div class="row">

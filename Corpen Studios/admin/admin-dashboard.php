...
<head>
  ...
  <meta name="description" content="Corpen Studios Booking System Transport Saccos, Matatu Industry">
  <meta name="author" content="MartDevelopers">
  <link rel="icon" href="vendor/img/CS Logo.png">
  <title>Corpen Studios Booking System - Admin Dashboard</title>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $driver;?></span> Photographers</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $vehicle;?></span> Packages</div>
              </div>

    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Photographer</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST"> 
            ...
            <button type="submit" name="update_user" class="btn btn-success">Update Photographer</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>

      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Photographer</label>
            ...
            <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Package Picture</label>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>

            <button type="submit" name="add_veh" class="btn btn-success">Add Package</button>
          </form>
          <!-- End Form-->
        </div>
      </div>

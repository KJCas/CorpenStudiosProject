      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Photographer</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Package Status</label>
            ...
            <div class="card-body">
                <h5 class="card-title">Package Picture</h5>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>
            </div>
            <hr>
            <button type="submit" name="upate_veh" class="btn btn-success">Update Package</button>
          </form>
          <!-- End Form-->
          <?php }?>
        </div>
